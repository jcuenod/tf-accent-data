...
def dataFromAccentCombo(accent_combo, prose_or_poetry):
	if prose_or_poetry == "poetic":
		return False
	if accent_combo in accentCatalog[prose_or_poetry]:
		return accentCatalog[prose_or_poetry][accent_combo]
	else:
		return False
